...
@pytest.mark.parametrize('numero_a, numero_b, resultado_esperado',ler_csv('C:\\Users\\Windows 10\\PycharmProjects\\134inicial\\vendors\\csv\\massa_teste_somar_positivo.csv'))
